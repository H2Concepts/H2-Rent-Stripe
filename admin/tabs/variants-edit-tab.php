...
<div class="produkt-edit-variant">
    <form method="post" action="" class="produkt-compact-form">
        ...
        <a href="<?php echo admin_url('admin.php?page=produkt-variants&category=' . $selected_category . '&delete=' . $edit_item->id . '&fw_nonce=' . wp_create_nonce('produkt_admin_action')); ?>"
            class="icon-btn variants-delete-btn" aria-label="<?php echo esc_attr__('Löschen', 'h2-rental-pro'); ?>"
            ...
            <div class="dashboard-card">
                ...
                <div class="produkt-form-group full-width">
                    ...
                    <textarea name="description"
                        rows="3"><?php echo esc_textarea($edit_item->description); ?></textarea>
                </div>
            </div>
                                                ...
                                                <?php foreach ($sale_product_colors as $color): ?>
                                                    <label class="produkt-toggle-label sale-option-toggle">
                                                        <input type="checkbox" name="sale_product_colors[]"
                                                            value="<?php echo esc_attr($color->id); ?>" class="sale-dependent" <?php checked(intval($color->sale_available ?? 0), 1); ?>>
                                                        <span class="produkt-toggle-slider"></span>
                                                ...
                                                <?php foreach ($sale_conditions as $condition): ?>
                                                    <label class="produkt-toggle-label sale-option-toggle">
                                                        <input type="checkbox" name="sale_conditions[]"
                                                            value="<?php echo esc_attr($condition->id); ?>" class="sale-dependent" <?php checked(intval($condition->sale_available ?? 0), 1); ?>>
                                                        <span class="produkt-toggle-slider"></span>
                    ...
                    <div class="price-cards">
                        <div class="price-card" data-field="verkaufspreis_einmalig">
                            ...
                            <div class="price-display">
                                ...
                                <span class="price-suffix">€</span>
                                <input type="hidden" name="verkaufspreis_einmalig" class="price-hidden"
                                    value="<?php echo intval(round($verkaufspreis_einmalig * 100)); ?>">
                            </div>
                        ...
                        <div class="price-card" data-field="weekend_price">
                            ...
                            <div class="price-display">
                                ...
                                <span class="price-suffix">€</span>
                                <input type="hidden" name="weekend_price" class="price-hidden"
                                    value="<?php echo intval(round($weekend_price * 100)); ?>">
                            </div>
                            <div class="price-buttons">
                                <button type="button" class="price-btn" data-step="-5">−5</button>
                                <button type="button" class="price-btn" data-step="-1">−1</button>
                ...
                <div class="form-grid">
                    <div class="produkt-form-group">
                        ...
                        <input type="text" name="availability_note"
                            value="<?php echo esc_attr($edit_item->availability_note ?? ''); ?>">
                    </div>
                    <div class="produkt-form-group">
                        <label><?php echo esc_html__('Lieferzeit-Text', 'h2-rental-pro'); ?></label>
                        <input type="text" name="delivery_time"
                            value="<?php echo esc_attr($edit_item->delivery_time ?? '3-5 Werktage'); ?>">
                    </div>
                    <?php if ($modus === 'kauf'): ?>
                        <div class="produkt-form-group">
                            <label class="produkt-toggle-label">
                        ...
                        <div class="produkt-form-group">
                            ...
                            <input type="number" name="min_rental_days"
                                value="<?php echo intval($edit_item->min_rental_days ?? 0); ?>" min="0">
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php for ($i = 1; $i <= 5; $i++): ?>
                        ...
                        <div class="produkt-image-upload">
                            ...
                            <input type="hidden" name="<?php echo $field; ?>" id="<?php echo $field; ?>"
                                value="<?php echo esc_attr($edit_item->$field ?? ''); ?>">
                        </div>
                    <?php endfor; ?>
                </div>
            </div>
