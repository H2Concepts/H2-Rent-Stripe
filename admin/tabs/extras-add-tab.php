                ...
                <div class="form-grid">
                    <div class="produkt-form-group">
                        ...
                        <input type="text" name="name" required
                            placeholder="<?php echo esc_attr__('z.B. Himmel, Zubehör-Set', 'h2-rental-pro'); ?>">
                    </div>
                </div>
            </div>
                            ...
                            <div class="variant-availability-card">
                                <div class="availability-card-head">
                                    ...
                                    <label class="produkt-toggle-label">
                                        <input type="checkbox" name="variant_available[<?php echo $v->id; ?>]" value="1"
                                            checked>
