        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="icon-btn" onclick="if(confirm('Bist du sicher das du Löschen möchtest?')){window.location.href='?page=produkt-durations&category=<?php echo $selected_category; ?>&delete=<?php echo $duration->id; ?>&fw_nonce=<?php echo wp_create_nonce('produkt_admin_action'); ?>';}" aria-label="Löschen">
