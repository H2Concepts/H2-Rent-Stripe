                ...
                <?php foreach ($rows as $r): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="icon-btn" aria-label="Löschen" onclick="if(confirm('Bist du sicher das du Löschen möchtest?')){window.location.href='?page=produkt-shipping&delete=<?php echo $r->id; ?>&fw_nonce=<?php echo wp_create_nonce('produkt_admin_action'); ?>';}">
