        ...
        <table class="form-table">
            ...
            <p>
                <button type="submit" name="save_category" class="icon-btn" aria-label="Speichern">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.3 80.3" width="20" height="20" fill="#2d6a4f">
    ...
    <div class="h2-rental-card card-category-list">
        <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <button id="add-category-btn" type="button" class="icon-btn" style="margin-right:20px;" aria-label="Hinzufügen">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80.3" width="24" height="24" fill="#2d6a4f">
            ...
            <tbody>
                <?php foreach ($categories as $cat): ?>
                    <tr>
                        ...
                        <td>
                            <a href="?page=produkt-kategorien&edit=<?php echo $cat->id; ?>" class="icon-btn" aria-label="Bearbeiten">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.8 80.1" width="20" height="20" fill="#2d6a4f">
                            ...
                            <a href="?page=produkt-kategorien&delete=<?php echo $cat->id; ?>" class="icon-btn" onclick="return confirm('Wirklich löschen?')" aria-label="Löschen">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.9 80.1" width="20" height="20" fill="#2d6a4f">
