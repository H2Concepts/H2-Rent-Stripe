...
<div class="produkt-admin dashboard-wrapper" id="produkt-admin-customers">
    <?php if (!$customer_id): ?>
        ...
        <p class="dashboard-subline"><?php echo esc_html__('Kunden verwalten', 'h2-rental-pro'); ?></p>

        <div class="product-info-grid cols-4">
            <div class="product-info-box bg-pastell-gelb">
                <div class="label"><?php echo esc_html__('Kunden', 'h2-rental-pro'); ?></div>
                <div class="value"><?php echo esc_html($total_customers); ?></div>
            </div>
            <div class="product-info-box bg-pastell-gruen">
                <div class="label"><?php echo esc_html__('Bestellungen', 'h2-rental-pro'); ?></div>
                <div class="value"><?php echo esc_html($total_orders); ?></div>
            </div>
            <div class="product-info-box bg-pastell-mint">
                <div class="label"><?php echo esc_html__('Umsatz', 'h2-rental-pro'); ?></div>
                <div class="value"><?php echo number_format($total_revenue, 2, ',', '.'); ?>€</div>
            </div>
            <div class="product-info-box bg-pastell-orange">
                <div class="label"><?php echo esc_html__('Ø pro Kunde', 'h2-rental-pro'); ?></div>
        ...
        <div class="h2-rental-card">
            <div class="card-header-flex">
                <div>
                    <h2><?php echo esc_html__('Kundenübersicht', 'h2-rental-pro'); ?></h2>
                    <p class="card-subline"><?php echo esc_html__('Kunden durchsuchen', 'h2-rental-pro'); ?></p>
                </div>
                <form method="get" class="produkt-filter-form product-search-bar">
                    ...
                    <div class="search-input-wrapper">
                        ...
                        <input type="text" name="s"
                            placeholder="<?php echo esc_attr__('Nach Namen suchen', 'h2-rental-pro'); ?>"
        ...
        <?php if (empty($kunden)): ?>
            <p><?php echo esc_html__('Keine Kunden gefunden.', 'h2-rental-pro'); ?></p>
        <?php else: ?>
                ...
                <?php foreach ($kunden as $kunde):
                    ...
                    <div class="customer-card">
                        ...
                        <p class="customer-phone">
                            <?php printf(esc_html__('Telefon: %s', 'h2-rental-pro'), esc_html($kunde->telefon ?: '–')); ?></p>
                        <div class="customer-orders-row">
                            <span
                                class="customer-orders"><?php printf(esc_html__('Bestellungen: %s', 'h2-rental-pro'), esc_html(count($kunde->orders))); ?></span>
                            <span
                                class="customer-last-order"><?php printf(esc_html__('Letzte Bestellung: %s', 'h2-rental-pro'), esc_html($last_order_date)); ?></span>
                        </div>
                        <div class="customer-actions">
                            <a href="<?php echo admin_url('admin.php?page=produkt-customers&customer=' . $kunde->id); ?>"
                                class="icon-btn icon-btn-no-stroke"
                            ...
                            <button type="button" class="icon-btn icon-btn-no-stroke customer-delete-btn"
                                aria-label="<?php echo esc_attr__('Kunde löschen', 'h2-rental-pro'); ?>"
                                data-customer-id="<?php echo esc_attr($kunde->id); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M18.3 5.7a1 1 0 0 0-1.4-1.4L12 9.17 7.1 4.3A1 1 0 0 0 5.7 5.7L10.6 10.6 5.7 15.5a1 1 0 1 0 1.4 1.4L12 12l4.9 4.9a1 1 0 0 0 1.4-1.4L13.4 10.6z" />
                                </svg>
                            </button>
                        </div>
                    </div>
    ...
    <?php else: ?>
        ...
        if (!$user) {
            echo '<p>' . esc_html__('Kunde nicht gefunden.', 'h2-rental-pro') . '</p></div>';
            return;
        }
        ...
        if ($year_orders <= 5) {
            $activity_score = esc_html__('Gering', 'h2-rental-pro');
        } elseif ($year_orders <= 12) {
            $activity_score = esc_html__('Mittel', 'h2-rental-pro');
        } else {
            $activity_score = esc_html__('Hoch', 'h2-rental-pro');
        }
        ...
        <h1 class="dashboard-greeting"><?php echo pv_get_time_greeting(); ?>,
            <?php echo esc_html(wp_get_current_user()->display_name); ?> 👋</h1>
        <p class="dashboard-subline"><?php echo esc_html__('Kundendetails', 'h2-rental-pro'); ?></p>

        <div class="product-info-grid cols-4">
            <div class="product-info-box bg-pastell-gelb">
                <div class="label"><?php echo esc_html__('Ausgaben', 'h2-rental-pro'); ?></div>
                <div class="value"><?php echo number_format($total_spent, 2, ',', '.'); ?>€</div>
            </div>
            <div class="product-info-box bg-pastell-gruen">
                <div class="label"><?php echo esc_html__('Abgeschlossen', 'h2-rental-pro'); ?></div>
                <div class="value"><?php echo esc_html($completed_orders); ?></div>
            </div>
            <div class="product-info-box bg-pastell-mint">
                <div class="label"><?php echo esc_html__('Abgebrochen', 'h2-rental-pro'); ?></div>
                <div class="value"><?php echo esc_html($canceled_orders); ?></div>
            </div>
            <div class="product-info-box bg-pastell-orange">
                <div class="label"><?php echo esc_html__('Activity Score', 'h2-rental-pro'); ?></div>
        ...
        <div class="customer-detail-grid">
            <div class="customer-left">
                <div class="dashboard-card customer-card">
                    ...
                    <p class="customer-phone">
                        <?php printf(esc_html__('Telefon: %s', 'h2-rental-pro'), esc_html($phone ?: '–')); ?></p>
                    <p class="customer-address">
                        <?php printf(esc_html__('Versandadresse: %s', 'h2-rental-pro'), esc_html($addr ?: '–')); ?></p>
                    <p class="customer-address">
                        <?php printf(esc_html__('Rechnungsadresse: %s', 'h2-rental-pro'), esc_html($addr ?: '–')); ?></p>
                    <p class="customer-registered">
                        <?php printf(esc_html__('Registriert: %s', 'h2-rental-pro'), esc_html($registered_date)); ?></p>
                    <p class="customer-last-activity">
                        <?php printf(esc_html__('Letzte Aktivität: %s', 'h2-rental-pro'), esc_html($last_activity_date)); ?>
                    </p>
                    <p class="customer-last-order">
                        <?php printf(esc_html__('Letzte Bestellung: %s', 'h2-rental-pro'), esc_html($last_order_date_card)); ?>
                    </p>
                </div>
                ...
                <div class="customer-row">
                    <div class="dashboard-card customer-tech-card">
                        ...
                        <p class="card-subline">
                            <?php echo esc_html__('Technische Informationen zum Nutzer', 'h2-rental-pro'); ?></p>
                        <p><strong><?php echo esc_html__('User Agent:', 'h2-rental-pro'); ?></strong>
                            <?php echo esc_html($last_order->user_agent ?? '–'); ?></p>
                        <p><strong><?php echo esc_html__('IP-Adresse:', 'h2-rental-pro'); ?></strong>
                            <?php echo esc_html($last_order->user_ip ?? '–'); ?></p>
                        <?php if ($client_info): ?>
                            <?php if (!empty($client_info['language'])): ?>
                                <p><strong><?php echo esc_html__('Sprache:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['language']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['languages'])): ?>
                                <p><strong><?php echo esc_html__('Weitere Sprachen:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['languages']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['timezone'])): ?>
                                <p><strong><?php echo esc_html__('Zeitzone:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['timezone']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['screen'])): ?>
                                <p><strong><?php echo esc_html__('Bildschirm:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['screen']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['viewport'])): ?>
                                <p><strong><?php echo esc_html__('Viewport:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['viewport']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['colorDepth'])): ?>
                                <p><strong><?php echo esc_html__('Farbtiefe:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['colorDepth']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['browser'])): ?>
                                <p><strong><?php echo esc_html__('Browser:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['browser']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['os'])): ?>
                                <p><strong><?php echo esc_html__('Betriebssystem:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['os']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['hardwareConcurrency'])): ?>
                                <p><strong><?php echo esc_html__('CPU-Kerne:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['hardwareConcurrency']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['deviceMemory'])): ?>
                                <p><strong><?php echo esc_html__('RAM:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['deviceMemory']); ?> GB</p><?php endif; ?>
                            <?php if (isset($client_info['touch'])): ?>
                                <p><strong><?php echo esc_html__('Touchscreen:', 'h2-rental-pro'); ?></strong>
                                    <?php echo $client_info['touch'] ? esc_html__('ja', 'h2-rental-pro') : esc_html__('nein', 'h2-rental-pro'); ?>
                                </p><?php endif; ?>
                            <?php if (!empty($client_info['connection'])): ?>
                                <p><strong><?php echo esc_html__('Netzwerk:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['connection']); ?></p><?php endif; ?>
                            <?php if (!empty($client_info['battery'])): ?>
                                <p><strong><?php echo esc_html__('Batterie:', 'h2-rental-pro'); ?></strong>
                                    <?php echo esc_html($client_info['battery']); ?></p><?php endif; ?>
                        <?php endif; ?>
                    </div>
                    <div class="dashboard-card">
                        <h2><?php echo esc_html__('Verlauf', 'h2-rental-pro'); ?></h2>
                        <p class="card-subline"><?php echo esc_html__('Benutzerverlauf im Detail', 'h2-rental-pro'); ?></p>
                        <?php if ($customer_logs): ?>
                            <?php
                            $display_logs = array_slice($customer_logs, 0, 10);
                            $has_more = count($customer_logs) > 10;
                            ?>
                                ...
                                foreach ($display_logs as $log):
                                    ...
                                    <div class="order-log-entry">
                                        ...
                                        <div class="log-body">
                                            ...
                                            <div class="log-date">
                                                <?php echo esc_html(date_i18n('d.m.Y H:i', strtotime($log->created_at)) . ' / #' . $order_no); ?>
                                            </div>
                            ...
                            <?php if ($has_more): ?>
                                <div class="customer-log-hidden" style="display: none;">
                                    <?php
                                    $hidden_logs = array_slice($customer_logs, 10);
                                    foreach ($hidden_logs as $log):
                                        $is_customer = !in_array($log->event, $system_events, true);
                                        $avatar = $is_customer ? $initials : 'H2';
                                        switch ($log->event) {
                                            case 'inventory_returned_not_accepted':
                                ...
                                <div style="margin-top: 12px;">
                                    <button type="button" class="button customer-log-toggle" data-expanded="false">
                                        <span class="toggle-text">Mehr anzeigen</span>
                                        <span class="toggle-text" style="display: none;">Weniger anzeigen</span>
                                    </button>
                                </div>
                            <?php endif; ?>
                            <?php if ($total_logs > $initial_log_count): ?>
                                <button type="button" class="icon-btn icon-btn-no-stroke customer-log-load-more"
                                    title="Mehr anzeigen" data-offset="<?php echo intval($initial_log_count); ?>"
                                    data-total="<?php echo intval($total_logs); ?>"
                                    data-order-ids="<?php echo esc_attr(implode(',', $order_ids)); ?>"
                                    data-initials="<?php echo esc_attr($initials); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path
                                            d="M12 5c-.6 0-1 .4-1 1v5H6c-.6 0-1 .4-1 1s.4 1 1 1h5v5c0 .6.4 1 1 1s1-.4 1-1v-5h5c.6 0 1-.4 1-1s-.4-1-1-1h-5V6c0-.6-.4-1-1-1z" />
                                    </svg>
                                </button>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <div class="card-header-flex">
                        ...
                        <form method="get" class="produkt-filter-form product-search-bar">
                            ...
                            <div class="search-input-wrapper">
                                ...
                                <input type="text" name="invoice_s" placeholder="Nach ID suchen"
                                    value="<?php echo esc_attr($invoice_search); ?>">
                            </div>
                                ...
                                <?php foreach ($invoices as $inv): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="details-cell">
                                            <a href="<?php echo esc_url($download_url); ?>" class="icon-btn icon-btn-no-stroke"
                                                target="_blank" download aria-label="Download">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path
                                                        d="M5 20h14v-2H5v2zm7-18v10l4-4 1.41 1.41L12 16.83 6.59 11.41 8 10l4 4V2h-2z" />
                                                </svg>
                                            </a>
                                        </td>
                                    </tr>
                ...
                <div class="dashboard-card">
                    <div class="card-header-flex">
                        ...
                        <button type="button" class="icon-btn icon-btn-no-stroke customer-note-icon"
                    ...
                    <div class="customer-notes-section">
                        <?php foreach ($customer_notes as $note): ?>
                            <div class="order-note" data-note-id="<?php echo intval($note->id); ?>">
                                ...
                                <div class="note-date">
                                    <?php echo esc_html(date_i18n('d.m.Y H:i', strtotime($note->created_at))); ?></div>
                                <button type="button" class="icon-btn customer-note-delete-btn" title="Notiz löschen"><svg
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.9 80.1">
                                        <path
            ...
            <div class="customer-right">
                <div class="dashboard-card">
                    <div class="card-header-flex">
                        ...
                        <form method="get" class="produkt-filter-form product-search-bar">
                            ...
                            <div class="search-input-wrapper">
                                ...
                                <input type="text" name="order_s" placeholder="Nach ID suchen"
                                    value="<?php echo esc_attr($order_search); ?>">
                            </div>
                            <button type="submit" class="icon-btn filter-submit-btn" aria-label="Filtern">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 22.1">
                                    <path
                    ...
                    <?php if ($orders): ?>
                        <?php
                        // Prüfe welche Bestellungen bewertet wurden
                        $customer_row_id = \ProduktVerleih\Database::get_customer_row_id_by_email($user->user_email);
                        $reviewed_orders = [];
                        if ($customer_row_id) {
                            // Sammle alle subscription_keys aus den Bestellungen
                            $subscription_keys_to_check = [];
                            foreach ($orders as $o) {
                                if (!empty($o->stripe_subscription_id)) {
                                    $base_key = trim((string) $o->stripe_subscription_id);
                                    // Prüfe für jedes Produkt in der Bestellung
                                    if (!empty($o->order_items)) {
                                        require_once PRODUKT_PLUGIN_PATH . 'includes/account-helpers.php';
                                        $items = pv_expand_order_products($o);
                                        foreach ($items as $idx => $item) {
                                            $subscription_keys_to_check[] = $base_key . '-' . $idx;
                                        }
                                    } else {
                                        $subscription_keys_to_check[] = $base_key . '-0';
                                    }
                                } elseif (!empty($o->subscription_id)) {
                                    $base_key = trim((string) $o->subscription_id);
                                    $subscription_keys_to_check[] = $base_key . '-0';
                                } else {
                                    // Fallback: order-id basiert
                                    $subscription_keys_to_check[] = 'order-' . $o->id . '-0';
                                }
                            }

                            if (!empty($subscription_keys_to_check)) {
                                $reviewed_keys = \ProduktVerleih\Database::get_reviewed_subscription_keys($customer_row_id, $subscription_keys_to_check);
                                $reviewed_orders = array_keys($reviewed_keys);
                            }
                        }
                        ?>
                        <table class="activity-table">
                            ...
                            <tbody>
                                <?php foreach ($orders as $o): ?>
                                    <?php
                                    // Prüfe ob diese Bestellung bewertet wurde
                                    $is_reviewed = false;
                                    if ($customer_row_id) {
                                        $check_keys = [];
                                        if (!empty($o->stripe_subscription_id)) {
                                            ...
                                            if (!empty($o->order_items)) {
                                                ...
                                                $items = pv_expand_order_products($o);
                                                foreach ($items as $idx => $item) {
                                                    $check_keys[] = $base_key . '-' . $idx;
                                                }
                                            } else {
                                                $check_keys[] = $base_key . '-0';
                                            }
                                        } elseif (!empty($o->subscription_id)) {
                                            $check_keys[] = trim((string) $o->subscription_id) . '-0';
                                        } else {
                                            $check_keys[] = 'order-' . $o->id . '-0';
                                        }

                                        if (!empty($check_keys)) {
                                            $reviewed = \ProduktVerleih\Database::get_reviewed_subscription_keys($customer_row_id, $check_keys);
                                            $is_reviewed = !empty($reviewed);
                                        }
                                    }
                                    ?>
                                    <tr>
                                        ...
                                        <td><?php echo $is_reviewed ? 'Ja' : 'Nein'; ?></td>
                                        ...
                                        <td class="details-cell">
                                            <button type="button" class="icon-btn icon-btn-no-stroke view-details-link"
                                                data-order-id="<?php echo esc_attr($o->id); ?>" aria-label="Details">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 22.1">
                                                    <path
                                                        d="M16,0C7.2,0,0,4.9,0,11s7.2,11,16,11,16-4.9,16-11S24.8,0,16,0ZM16,20c-7.7,0-14-4-14-9S8.3,2,16,2s14,4,14,9-6.3,9-14,9ZM16,5c-3.3,0-6,2.7-6,6s2.7,6,6,6,6-2.7,6-6-2.7-6-6-6ZM16,15c-2.2,0-4-1.8-4-4s1.8-4,4-4,4,1.8,4,4-1.8,4-4,4Z" />
                                                </svg>
