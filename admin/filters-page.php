...
<div class="produkt-admin dashboard-wrapper">
    ...
    <p class="dashboard-subline"><?php echo esc_html__('Filter verwalten', 'h2-rental-pro'); ?></p>
    ...
    <div class="dashboard-grid">
        <div class="dashboard-left">
            <div class="dashboard-card">
                <div class="card-header-flex">
                    <div>
                        <h2><?php echo esc_html__('Alle Filter Kategorien', 'h2-rental-pro'); ?></h2>
                        <p class="card-subline">
                            <?php echo esc_html__('Übersicht der Filtergruppen', 'h2-rental-pro'); ?></p>
                    </div>
                    <button type="button" class="icon-btn add-category-btn"
                        aria-label="<?php echo esc_attr__('Hinzufügen', 'h2-rental-pro'); ?>"
                        onclick="window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&add_group=1'); ?>'">
                            ...
                            <tr>
                                <td colspan="2">
                                    <form method="post" class="inline-form">
                                        ...
                                        <button type="submit" name="save_group" class="icon-btn"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <form method="post" class="inline-form">
                                            ...
                                            <input type="text" name="name" value="<?php echo esc_attr($g->name); ?>" required
                                                class="regular-text">
                                            <button type="submit" name="save_group" class="icon-btn"
                                                aria-label="<?php echo esc_attr__('Speichern', 'h2-rental-pro'); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.3 80.3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="icon-btn"
                                            aria-label="<?php echo esc_attr__('Optionen', 'h2-rental-pro'); ?>"
                                            onclick="window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&group=' . $g->id); ?>'">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80.3">
                                                <path
                                                    d="M12.1,12c-15.4,15.4-15.4,40.4,0,55.8,7.7,7.7,17.7,11.7,27.9,11.7s20.2-3.8,27.9-11.5c15.4-15.4,15.4-40.4,0-55.8-15.4-15.6-40.4-15.6-55.8-.2h0ZM62.1,62c-12.1,12.1-31.9,12.1-44.2,0-12.1-12.1-12.1-31.9,0-44.2,12.1-12.1,31.9-12.1,44.2,0,12.1,12.3,12.1,31.9,0,44.2Z" />
                                                <path
                                        ...
                                        <button type="button" class="icon-btn"
                                            ...
                                            onclick="window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&edit_group=' . $g->id); ?>'">
                                        ...
                                        <button type="button" class="icon-btn"
                                            ...
                                            onclick="if(confirm('<?php echo esc_js(__('Bist du sicher das du Löschen möchtest?', 'h2-rental-pro')); ?>')){window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&delete_group=' . $g->id . '&fw_nonce=' . wp_create_nonce('produkt_admin_action')); ?>';}">
        ...
        <div class="dashboard-right">
            <div class="dashboard-card">
                <div class="card-header-flex">
                    <div>
                        <h2><?php echo esc_html__('Filteroptionen', 'h2-rental-pro'); ?></h2>
                        <p class="card-subline"><?php echo esc_html__('Fügen Sie Filter hinzu', 'h2-rental-pro'); ?></p>
                    </div>
                    <?php if ($current_group): ?>
                        <button type="button" class="icon-btn add-category-btn"
                            aria-label="<?php echo esc_attr__('Hinzufügen', 'h2-rental-pro'); ?>"
                            onclick="window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&group=' . $current_group->id . '&add_option=1'); ?>'">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80.3">
                                <path
                                    d="M12.1,12c-15.4,15.4-15.4,40.4,0,55.8,7.7,7.7,17.7,11.7,27.9,11.7s20.2-3.8,27.9-11.5c15.4-15.4,15.4-40.4,0-55.8-15.4-15.6-40.4-15.6-55.8-.2h0ZM62.1,62c-12.1,12.1-31.9,12.1-44.2,0-12.1-12.1-12.1-31.9,0-44.2,12.1-12.1,31.9-12.1,44.2,0,12.1,12.3,12.1,31.9,0,44.2Z" />
                                <path
                ...
                <table class="activity-table">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <form method="post" class="inline-form">
                                            ...
                                            <button type="submit" name="save_option" class="icon-btn"
                                                aria-label="<?php echo esc_attr__('Speichern', 'h2-rental-pro'); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.3 80.3">
                                                    <path
                                                        d="M32,53.4c.8.8,1.9,1.2,2.9,1.2s2.1-.4,2.9-1.2l20.8-20.8c1.7-1.7,1.7-4.2,0-5.8-1.7-1.7-4.2-1.7-5.8,0l-17.9,17.9-7.7-7.7c-1.7-1.7-4.2-1.7-5.8,0-1.7,1.7-1.7,4.2,0,5.8l10.6,10.6Z" />
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <form method="post" class="inline-form">
                                                ...
                                                <input type="text" name="option_name" value="<?php echo esc_attr($opt->name); ?>"
                                ...
                                <?php else: ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="icon-btn"
                                                aria-label="<?php echo esc_attr__('Bearbeiten', 'h2-rental-pro'); ?>"
                                                onclick="window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&group=' . $current_group->id . '&edit_option=' . $opt->id); ?>'">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.8 80.1">
                                                    <path
                                                        d="M54.7,4.8l-31.5,31.7c-.6.6-1,1.5-1.2,2.3l-3.3,18.3c-.2,1.2.2,2.7,1.2,3.8.8.8,1.9,1.2,2.9,1.2h.8l18.3-3.3c.8-.2,1.7-.6,2.3-1.2l31.7-31.7c5.8-5.8,5.8-15.2,0-21-6-5.8-15.4-5.8-21.2,0h0ZM69.9,19.8l-30.8,30.8-11,1.9,2.1-11.2,30.6-30.6c2.5-2.5,6.7-2.5,9.2,0,2.5,2.7,2.5,6.7,0,9.2Z" />
                                                    <path
                                            ...
                                            <button type="button" class="icon-btn"
                                                aria-label="<?php echo esc_attr__('Löschen', 'h2-rental-pro'); ?>"
                                                onclick="if(confirm('<?php echo esc_js(__('Bist du sicher das du Löschen möchtest?', 'h2-rental-pro')); ?>')){window.location.href='<?php echo admin_url('admin.php?page=produkt-filters&group=' . $current_group->id . '&delete_option=' . $opt->id . '&fw_nonce=' . wp_create_nonce('produkt_admin_action')); ?>';}">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.9 80.1">
                                                    <path
                                                        d="M39.8.4C18,.4.3,18.1.3,40s17.7,39.6,39.6,39.6,39.6-17.7,39.6-39.6S61.7.4,39.8.4ZM39.8,71.3c-17.1,0-31.2-14-31.2-31.2s14.2-31.2,31.2-31.2,31.2,14,31.2,31.2-14.2,31.2-31.2,31.2Z" />
                                                    <path
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="2">
                                    <?php echo esc_html__('Wählen Sie eine Filterkategorie', 'h2-rental-pro'); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
